  ...
  return (
    <div className="cardItem">
      ...
      <div className="cardItem_wrapper">
        <div className="cardItem_ammount">
        ...
        <div className="cardItem_cashBack-img">
          ...
          <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" focusable="false">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M12.667 11.167 8 2 5.398 7.112 1 4.444l2.087 6.123c.07.204.155.398.255.582l-.009.018C3.682 12.262 4.66 13 5.761 13h6.322l.584-1.833Z"
              fill="currentColor"
            ></path>
            <path
              opacity=".65"
              fillRule="evenodd"
              clipRule="evenodd"
              d="m10.602 7.112 2.065 4.055L12.083 13 15 4.444l-4.398 2.668ZM5.762 13c-.187 0-.37-.021-.547-.062.144.04.296.062.452.062h.094Z"
              fill="currentColor"
            ></path>
          </svg>
        </div>
